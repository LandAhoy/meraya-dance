...
export default function Home() {
  ...
  return <main>
    <section className="hero" id="home"><div className="glow glow-one" /><div className="glow glow-two" /><div className="glow glow-three" /><div className="halo halo-one" /><div className="halo halo-two" />
      ...
      <div className="hero-content hero-enter"><a className="hero-instagram" href="https://www.instagram.com/meraya.dance/" target="_blank" rel="noreferrer" aria-label="Follow Meraya Dance on Instagram"><svg className="instagram-icon" viewBox="0 0 24 24" aria-hidden="true"><defs><linearGradient id="instagram-gradient" x1="0" y1="24" x2="24" y2="0" gradientUnits="userSpaceOnUse"><stop stopColor="#feda75" /><stop offset=".33" stopColor="#fa7e1e" /><stop offset=".63" stopColor="#d62976" /><stop offset="1" stopColor="#4f5bd5" /></linearGradient></defs><rect x="2" y="2" width="20" height="20" rx="6" fill="url(#instagram-gradient)" /><circle cx="12" cy="12" r="4.25" fill="none" stroke="white" strokeWidth="1.8" /><circle cx="17.35" cy="6.7" r="1.15" fill="white" /></svg><span>Follow Meraya Dance</span><b aria-hidden="true">↗</b></a><h1>Move <span className="freely-word">freely.<img className="hero-logo-inline" src="/assets/meraya-logo-transparent.png" alt="Meraya Dance" /></span><br />Feel deeply.</h1><p className="intro">A home for rhythm, expression and the joy of becoming more yourself through dance.</p><a className="text-link" href="#classes">Explore Meraya <span>↓</span></a></div><div className="hero-footer"><p>DISCOVER<br />YOUR RHYTHM</p><p className="scroll">SCROLL TO MOVE <span>↓</span></p></div>
    </section>
